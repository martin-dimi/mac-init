...
M.setup = function(opts)
  ...
  if not opts.dark_theme then
    error("No default dark theme specified. Please set opts.dark_theme in theme-loader setup.")
  end

  if not opts.light_theme then
    error("No default light theme specified. Please set opts.light_theme in theme-loader setup.")
  end
